...
remove:function(a){return d.localStorage.removeItem(a)},length:function(){return d.localStorage.length},key:function(a){return 0>a||a>=this.length()?void 0:d.localStorage.key(a)},enabled:function(){return j}},session:{set:function(a,b){return d.sessionStorage.setItem(a,b)},get:function(a){return d.sessionStorage.getItem(a)},remove:function(a){return d.sessionStorage.removeItem(a)},length:function(){return d.sessionStorage.length},key:function(a){return 0>a||a>=this.length()?void 0:d.sessionStorage.key(a)},
